...
(function(factory) {
    ...
    Timer.prototype.start = function(options) {
        ...
        this.targetElement.each(function(_index, timerBox) {
            ...
            timerBoxElement.on('complete', function() {
                ...
                that.startCountUp(timerBoxElement, {
    ...
    Timer.prototype.startCountdown = function(element, options) {
     ...
     Timer.prototype.startCountUp = function(element) {
        var sec = 0;
        function pad ( val ) { return val > 9 ? val : "0" + val; }
        setInterval( function(){
            element.find('.jst-minutes').html('-'+pad(parseInt(sec/60,10))+':');
            element.find('.jst-seconds').html(pad(++sec%60));
            element.find('.jst-minutes').css({'color':'#f00'});
            element.find('.jst-seconds').css({'color':'#f00'});
        }, 1000);
    };
