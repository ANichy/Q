...
console.log( 'Export PDF: Reading reveal_init.js config [1/4]' );
...
probePage.open( inputFile, function( status ) {
	...
	if( config ) {
        ...
        console.log( 'Export PDF: Unable to read reveal_init.js config. Make sure the input address points to a reveal_init.js page.' );
        phantom.exit(1);
